                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-3">
                            <div class="col-lg-3">
                                <input type="checkbox" id="set_halaman_depan" name="set_halaman_depan" value="1" <?= (isset($set_halaman_depan))? ($set_halaman_depan == 1) ? 'checked' : '' : ''; ?>>
                                <label for="set_halaman_depan">Halaman Depan?</label>
                            </div>
                            <div class="col-lg-3">
                                <input type="checkbox" id="set_halaman_kontak" name="set_halaman_kontak" value="1" <?= (isset($set_halaman_kontak))? ($set_halaman_kontak == 1) ? 'checked' : '' : ''; ?>>
                                <label for="set_halaman_kontak">Halaman Kontak?</label>
                            </div>
                        </div>
                        <div>
