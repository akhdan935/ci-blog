                                ...
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        <form method="POST" action="">
                                            ...
                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="inputPasswordKonfirmasi" type="password" placeholder="Password" name="konfirmasi_password" />
                                                <label for="inputPasswordKonfirmasi">Konfirmasi password</label>
                                            </div>
                                            <!-- <div class="form-check mb-3">
                                                <input class="form-check-input" id="inputRememberPassword" type="checkbox" value="1" name="remember_me" />
